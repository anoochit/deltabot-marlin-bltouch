 ...
 * < 08:27:56: .Height:275.07  Ex:-2.54  Ey:-0.28  Ez:+0.00  Radius:111.56
 */
...
#define DELTA
  ...
  // Height:275.07  Ex:-2.54  Ey:-0.28  Ez:+0.00  Radius:111.56
  // M666 X-2.54 Y-0.28 Z0.00
  // M665 L217.00 R111.56 H275.07 S200.00 B70.00 X0.00 Y0.00 Z0.00

  // M666 X-2.98 Y0.00 Z-0.06
  // Delta settings: L<diagonal_rod> R<radius> H<height> S<segments_per_s> B<calibration radius> XYZ<tower angle corrections>
  // M665 L217.00 R110.20 H275.22 S200.00 B70.00 X-0.69 Y0.22 Z0.47
  // M92 E98.20
  ...
  #define DELTA_HEIGHT (274.15) // get this value from auto calibrate

  //< 08:43:54: echo:  M666 X-2.54 Y-0.28 Z0.00
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 98.2 }  // default steps per unit for Kossel (GT2, 20 tooth)
